...
public:	
	...
	FServerSideRewindResult ServerSideRewind(class ABlastCharacter* HitCharacter, const FVector_NetQuantize& TraceStart, const FVector_NetQuantize& HitLocation, float HitTime);
